...
//CLO
	...
	@Parameter(names={sLIST, LIST}, variableArity = true, description ="Description: Pairs of URL & title expected. Separators of Pairs is \"|\". Example: \"http://www.youtube.com|YouTube\" ")
	...
	{
		new JCommander(new Selenium_multi(), args);	
		if (help){
			new JCommander(new Selenium_multi(), args).usage();	
			System.exit(0);
			}
